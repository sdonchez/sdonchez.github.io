	...
	<b-container fluid="true">
		...
		<b-row class="bg-primary px-5">
			...
			<b-row class="copy">
				...
				<p>
					You can also download my <a href="SDonchezResumeJune2022.pdf" target="_blank"> resume</a> or visit me on	<a href="https://www.linkedin.com/in/stephen-donchez/" target="_blank"> LinkedIn</a> to learn more about my professional and academic activities.
				</p>
			</b-row>
		</b-row>
	</b-container>
